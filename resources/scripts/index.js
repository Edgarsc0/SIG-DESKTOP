...
const DOWNLOAD_DIR =
  process.argv[3] || path.join(os.homedir(), "Downloads", "ZafiroDescargas");
const HEADLESS = process.argv[4] !== '0';

const CHECKBOX_IDS = [
  "ZAFIRO_WRK_FLAG1", //Posiciones
  "ZAFIRO_WRK_FLAG2", //Empleados Activos
  "ZAFIRO_WRK_FLAG3", //Empleados bajas
  "ZAFIRO_WRK_FLAG4", //Familiares
  "ZAFIRO_WRK_FLAG7", //Escolaridad
];

const argIndex = parseInt(process.argv[2]);
const TARGET_ID = CHECKBOX_IDS[argIndex - 1];
