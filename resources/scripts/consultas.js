...
const main = async () => {
  ...
  try {
    ...
    await driver.wait(
      until.elementLocated(By.css(".EOPP_SCCHILDCONTENTLINK")),
      10000,
    );
    ...
    await driver.wait(
      until.elementLocated(By.id("QRYSELECT_WRK_QRYSEARCHTEXT254")),
      10000,
    );
    const input = await driver.findElement(
      By.id("QRYSELECT_WRK_QRYSEARCHTEXT254"),
    );
    await input.sendKeys(CONSULTA_NAME);

    await driver.wait(
      until.elementLocated(By.id("QRYSELECT_WRK_QRYSEARCHBTN")),
      10000,
    );
    ...
    await driver.wait(
      until.elementLocated(By.id("QRYSELECT_WRK_QRYSCHEDULE$0")),
      10000,
    );
    ...
    await driver.wait(
      until.elementLocated(By.id("PMN_PRCSLIST_DISTSTATUS$0")),
      10000,
    );
